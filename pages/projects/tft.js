  ...
  return (
    <Layout>
      ...
      >
        ...
        <Typography variant="body2">Sep. - Oct. 2022</Typography>
      </Box>

      <Box sx={{ mb: 4 }}>
        <Typography variant="h3" component="h1" sx={{ mb: 4 }}>
          <strong>Team Fight Tactics Redesign</strong>
        </Typography>
        <Typography>
          Redesign of the Team Fight Tactics customization interface for mobile devices. This redesign pertains to set 7.5
        </Typography>
      </Box>
